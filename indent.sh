...
-T ddn_dbg_t -T ddns_cmd_t -T ddns_system_t -T ddns_server_name_t -T ddns_alias_t \
-T http_client_t -T http_trans_t -T tcp_sock_t -T ip_sock_t \
-T cmd_data_t -T cmd_handler_t -T cmd_desc_t -T state_t -T cfg_parser_t \
$*
