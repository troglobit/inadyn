...
static const ERROR_NAME global_error_table[] = {
	...
	{RC_TCP_SOCKET_CREATE_ERROR, "RC_TCP_SOCKET_CREATE_ERROR"},
	{RC_TCP_BAD_PARAMETER, "RC_TCP_BAD_PARAMETER"},
	{RC_TCP_INVALID_REMOTE_ADDR, "RC_TCP_INVALID_REMOTE_ADDR"},
	{RC_TCP_CONNECT_FAILED, "RC_TCP_CONNECT_FAILED"},
	{RC_TCP_SEND_ERROR, "RC_TCP_SEND_ERROR"},
	{RC_TCP_RECV_ERROR, "RC_TCP_RECV_ERROR"},
	{RC_TCP_OBJECT_NOT_INITIALIZED, "RC_TCP_OBJECT_NOT_INITIALIZED"},
	{RC_TCP_OS_SOCKET_INIT_FAILED, "RC_TCP_OS_SOCKET_INIT_FAILED"},
